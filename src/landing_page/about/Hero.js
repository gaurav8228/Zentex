...
function Hero() {
  return (
    <div className="container mb-5">
      ...
      <div className="row p-5 mt-5 border-top lh-lg text-muted  ">
        ...
        <div className="col-6 p-5">
          ...
          <p>
            ...
            Catch up on the latest updates on our <a href="" style={{textDecoration:"none"}}>blog</a> or see what
            the media is  <a href="" style={{textDecoration:"none"}}>saying about us</a> or learn more about our 
